...
const Board: React.FC<BoardProps> = ({ gameState, onPieceClick }) => {
  ...
  return (
    ...
    <div className="w-full max-w-[600px] aspect-square relative bg-[#5c4033] p-1 sm:p-3 md:p-6 rounded-sm shadow-2xl mx-auto max-h-[50vh] sm:max-h-[85vh] select-none">
